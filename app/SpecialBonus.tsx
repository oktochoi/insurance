      ...
      <RevealOnScroll>
        <div className="container-section section-y">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm font-medium text-gray-600">조건 상관없이 누구나 받을 수 있어요</p>
          </div>
          <div className="mx-auto mt-8 grid max-w-4xl grid-cols-1 gap-4 sm:mt-10 md:grid-cols-2 md:gap-6">
            <div className="rounded-2xl border border-amber-200/80 bg-white p-5 shadow-[0_14px_36px_rgba(180,83,9,0.15)] sm:p-6">
